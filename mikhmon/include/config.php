...
$data['new-2139'] = array ('1'=>'new-2139!','new-2139@|@','new-2139#|#','new-2139%','new-2139^','new-2139&Rp','new-2139*10','new-2139(1','new-2139)','new-2139=10','new-2139@!@disable');
$data['KyambogoAirSite'] = array ('1'=>'KyambogoAirSite!192.168.100.5','KyambogoAirSite@|@admin','KyambogoAirSite#|#aWNlbA==','KyambogoAirSite%KyambogoAir Hotspot','KyambogoAirSite^KyambogoAir.online','KyambogoAirSite&Rp','KyambogoAirSite*10','KyambogoAirSite(1','KyambogoAirSite)','KyambogoAirSite=10','KyambogoAirSite@!@disable');
$data['KyambogoAir'] = array ('1'=>'KyambogoAir!192.168.100.5','KyambogoAir@|@admin','KyambogoAir#|#mZWfoZ8=','KyambogoAir%KyambogoAir Hotsport','KyambogoAir^kyambogoAir.onlin','KyambogoAir&UGX','KyambogoAir*10','KyambogoAir(1','KyambogoAir)','KyambogoAir=10','KyambogoAir@!@disable');